...
var argv = require('yargs')
  .usage('Usage: keystash <bucket> [option]')
  .example('keystash', 'List all secrets')
  .example('keystash bukkit keyname keyvalue', 'Save a secret')
  .example('keystash bukkit keyname', 'Get a secret')
